...
/>
      ...
      >
        ...
        {/* Subrayado corto bajo el claim (a la derecha) */}
        <line x1="73%" y1="58%" x2="80%" y2="58%" stroke="#D9B25F" strokeWidth="2" />

        {/* Corner bracket bottom right */}
        <path
          d="M 92% 92% L 96% 92% L 96% 88%"
          fill="none"
          stroke="white"
          strokeOpacity="0.5"
          strokeWidth="1.5"
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-6 md:px-12 h-full flex items-center">
        <div className="w-full grid grid-cols-1 md:grid-cols-10 gap-0 items-center">
          ...
          <div className="md:col-span-4 flex flex-col justify-center">
            <h1 className="text-6xl md:text-[9rem] lg:text-[11rem] font-editorial text-white leading-none tracking-tighter select-none opacity-95">
              NODUS
            </h1>
          ...
          {/* Claim Right */}
          <div className="md:col-start-7 md:col-span-4 mt-16 md:mt-0 pl-4 md:pl-8">
